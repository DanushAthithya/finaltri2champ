...
function Eventreg() {
  ...
  const handleParticipantEntry = () => {
    if (validate()) {
      ...
      const newUserRef = push(ref(database, "Event/"+eventName+"/Participants"));
  ...
  function ticket(){
    // should contain the code for mailjet to send email conatining ticket
    // should be processed after payment along with handleParticipantEntry
  }
